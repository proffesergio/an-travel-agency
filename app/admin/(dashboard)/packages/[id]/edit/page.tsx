    ...
    const loadPackage = async () => {
      ...
      try {
        ...
        setForm({
          ...
          inclusionsBn: pkg.inclusionsBn?.length ? pkg.inclusionsBn : [''],
          itinerary: pkg.itinerary?.length ? pkg.itinerary : [{ day: '', title: '', description: '' }],
      ...
      if (!res.ok) {
        ...
        const fieldMsg = issues?.fieldErrors
          ? Object.entries(issues.fieldErrors)
              ...
              .join(' · ')
          : null;
        throw new Error(fieldMsg || data?.error || 'Failed to update package');
      }
    ...
    <div className="p-4 sm:p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Update package details</p>
        </div>
      </div>
