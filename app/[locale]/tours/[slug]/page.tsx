        ...
        <div className="relative h-72 sm:h-96 bg-gray-800">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="max-w-7xl mx-auto px-4 w-full pb-8">
              <span className="inline-block bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase">Tour</span>
              ...
              <div className="flex items-center gap-6 mt-3 text-white/80 text-sm">
                ...
                <span className="flex items-center gap-1"><Users className="w-4 h-4" />Guided Group Tour</span>
