  ...
  return (
    <main className="flex-1">
      ...
      <div className="bg-amber-50 border-b border-amber-200 py-3 px-4 text-center text-sm text-amber-800">
        <strong>Important:</strong> Hajj 2027 registrations are now open.
        Limited seats available. Call{" "}
        <a href="tel:+8801843431743" className="font-bold underline">
          +88 01843 431743
        </a>{" "}
        to register.
      </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8">
            We have been serving Bangladeshi pilgrims for over 15 years with
            government-approved packages, dedicated Mutawwif support, and
            transparent pricing.
          </p>
